...
export const maxDuration = 60; // Максимальний час виконання функції на Vercel
...
- Ім'я: Ванда Орлова
- Стиль та авторська техніка: Авторський художній стиль солярісм, Графічні ілюстрації
- Техніки та матеріали: Авторська техніка створення сонячних зайчиків на полотні, Олія на полотні, Мультишаровий акриловий живопис, Золота поталь, Цифрова графіка
- Тематика: Українська культурна спадщина, Пейзажі
- Серії робіт: Голос березового гаю, Культурна спадщина України, Світанки, Про любов
